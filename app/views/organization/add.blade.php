...
@section('content')
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <!-- form start -->
            {{ Form::open(array('url' => action('OrganizationsController@postAdd'), 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal')) }}
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="os-form-group col-md-12  col-xs-12">
                        ...
                        <div class="input-container">
                            <input type="text" required="required"  name="short_name" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="os-form-group col-md-3  col-xs-3">
                        ...
                        <div class="input-container">
                            <input type="text" required="required"  name="contract_number" class="form-control">
                        </div>
                    </div>
                    <div class="os-form-group col-md-3  col-xs-3">
                    ...
                    <div class="os-form-group col-md-3  col-xs-3">
                        ...
                        <div class="input-container">
                            <input type="text" required="required"   name="inn" class="form-control">
                        </div>
                    </div>
                    <div class="os-form-group col-md-3  col-xs-3">
                ...
                <div class="form-group">
                    <div class="os-form-group col-md-6  col-xs-6">
                        ...
                        <div class="input-container">
                            <input type="text"  required="required"  name="fact_address" class="form-control">
                        </div>
                    </div>
                    <div class="os-form-group col-md-6  col-xs-6">
                        <label  class="control-label">Юридический адрес</label>
                        <div class="input-container">
                            <input type="text" required="required"   name="legal_address" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="os-form-group col-md-3  col-xs-3">
                        ...
                        <div class="input-container">
                            <input type="number"   name="ks" class="form-control">
                        </div>
                    </div>
                    <div class="os-form-group col-md-3  col-xs-3">
                        <label  class="control-label">БИК</label>
                        <div class="input-container">
                            <input type="number"   name="bik" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="os-form-group col-md-6  col-xs-6">
                        ...
                        <div class="input-container">
                            <input type="text"  required="required"  name="operate_foundation" class="form-control">
                        </div>
                    </div>
                    <div class="os-form-group col-md-6  col-xs-6">
                        <label  class="control-label">В банке</label>
                        <div class="input-container">
                            <input type="text" required="required"   name="bank" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="os-form-group col-md-7  col-xs-7">
                        ...
                        <div class="input-container">
                            <input type="text"  required="required"  name="fio" class="form-control">
                        </div>
                    </div>
                    <div class="os-form-group col-md-5  col-xs-5">
                        <label  class="control-label">Должность руководителя</label>
                        <div class="input-container">
                            <input type="text" required="required"   name="boss_position" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
