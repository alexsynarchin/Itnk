                ...
                @if(($item->document->os_type=='movables')||($item->document->os_type=='value_movables')||($item->document->os_type=='buildings'))
                    <div class="form-group">
                        <div class="os-form-group col-md-5 col-xs-5">
                            ...
                            <div class="input-container">
                                <input  type="decimal" value="{{$item->variable->residual_value}}" name="residual_value" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="os-form-group col-md-4 col-xs-4">
                            ...
                            <div class="input-container">
                                <input  required="required" type="number" value="{{$item->variable->useful_life}}" name="useful_life" class="form-control">
                            </div>
                        </div>
                    </div>
                @endif
